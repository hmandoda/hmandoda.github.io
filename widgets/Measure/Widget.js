...
//             - updated the editing as the event handlers had also changed in the API.  TODO: found esri bug on edit toolbar that creates a 
//               ghost vertex as the last vertex.  This creates issues when editing a polyline or polygon.
    ...
    function(declare, _WidgetsInTemplateMixin, BaseWidget, GraphicsLayer, Edit, Graphic, Extent, Point,
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            _bindEvents: function() {
 				// break;  // use this to expose the widget.js in the chrome developer window.
               //bind DrawBox
				...
				if (isGhostVertex) {
					...
					if (pointIndex === 0) {
						if (geomtype === 'polyline') {
							...
							this.editGraphic1 = this._findDimensionGraphic(gra._graphicsLayer, gra.attributes.id, pointIndex + 1);
							this.editGraphic2 = this._findDimensionGraphic(gra._graphicsLayer, gra.attributes.id, l - 2);  // esri bug polygon has too many vertices
						}
